import { Box, Flex, Image, Text, List } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      ...
      <Box mt={["4rem", "8rem"]} mb={["2rem", "8rem"]}>
        ...
        >
          <Flex direction="row" gap={[4, 4, 5, 5]}>
            <Box flexShrink={0}>
              <GlowingDot />
            </Box>
            <Text
            ...
            >
              I'm currently seeking my next challenge and would love to hear
              from you. If you're looking for someone who can spar on
              architecture diagrams, critique a color palette, or just geek out
              over the future of AGI, let's talk.
            </Text>
          </Flex>
        </FrostedCard>
      </Box>
